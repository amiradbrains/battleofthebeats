...
class AuditionController extends Controller
{
    ...
    public function __construct()
    {
        $this->validation_fields = [
            ...
            'unique_qualities' => 'nullable|string|max:200',
            'main_goal_difficulties' => 'nullable|string|max:200',
            'biggest_strength_support' => 'required|string|max:200',
            'favorite_judge_why' => 'required|string|max:200',
            'role_model_inspiration' => 'nullable|string|max:200',
            'written_composed_song_inspiration' => 'nullable|string|max:200',
