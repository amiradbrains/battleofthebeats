    ...
    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form class="user-form-section"  method="POST" action="{{ isset($user->details) ? route('user-details.update', $user->details->id) : route('user-details.store') }}" enctype="multipart/form-data">
                    @csrf
