...
@if (isset($members))
    ...
    <div class="form-floatingXXX  d-flex flex-column-reverse form-floating-outline mb-3">
        ...
        <label for="previous_performance">Have you participated in any Reality Show? <span
                class="required">*</span></label>
    </div>
    ...
    <div class="form-floatingXXX  d-flex flex-column-reverse form-floating-outline mb-3">
        ...
        <label for="group_together">How did you all came up together being a group? <span
                class="required">*</span></label>
    </div>
    ...
    <div class="form-floatingXXX  d-flex flex-column-reverse form-floating-outline mb-3">
        ...
        <label for="why_tup_expectations">Why “The Next {{ $ing }} Superstar” and what are your expectations
            from
    ...
    <div class="form-floatingXXX  d-flex flex-column-reverse form-floating-outline mb-3">
        ...
        <label for="written_composed_song_inspiration">Have you ever composed or performed any dance choreography with
            the
    ...
    <div class="form-floatingXXX  d-flex flex-column-reverse form-floating-outline mb-3">
        ...
        <label for="main_goal_difficulties">What is your goal and what are the difficulties you are facing to achieve
            the
    ...
    <div class="form-floatingXXX  d-flex flex-column-reverse form-floating-outline mb-3">
        ...
        <label for="role_model_inspiration">What/who is your inspiration for taking a step forward in
            {{ $ing }}?
            <span class="required">*</span></label>
    </div>
    ...
    <div class="form-floatingXXX  d-flex flex-column-reverse form-floating-outline mb-3">
        ...
        <label for="prepared_songs">What Bollywood {{ $er }}s style you can perform the best? (Any 2
            Atleast)
            <span class="required">*</span></label>
    </div>
@endif
