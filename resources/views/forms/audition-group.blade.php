...
@if (isset($members))
    ...
    <div class="form-floatingXXX  d-flex flex-column-reverse form-floating-outline mb-3">
        ...
        <label for="written_composed_song_inspiration">Have you ever composed or performed any dance choreography by
            your own? If yes, we would like to know about your journey for the same. <span
                class="required">*</span></label>
    </div>
    ...
    <div class="form-floatingXXX  d-flex flex-column-reverse form-floating-outline mb-3">
        ...
        <label for="dance_style">What Dance Style your group can perform the best? (Any 2 Atleast)
            <span class="required">*</span></label>
    </div>
@endif
