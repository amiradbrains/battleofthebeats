    ...
    <div
        ...
        <div class="social-icon-group">
            <ul>
                ...
                <li><a href="https://www.youtube.com/@BattleoftheBeatsOfficial" target="_blank"><svg fill="#ffffff"
                            width="35px" height="35px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"
                            stroke="#ffffff">
                ...
                <li><a href="https://www.instagram.com/battleofthebeatsofficial/" target="_blank"><svg width="25px"
                ...
                <li><a href="https://www.facebook.com/battleofthebeatsofficial" target="_blank"><svg width="30px"
                            height="30px" viewBox="-5 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8  z-10">
            ...
            <div class="mt-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    @foreach ($plans as $plan)
                        ...
                        @endphp
                        <div
                            class="box-content scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                    ...
                    @endrole
                        ...
                        @else  style="cursor: not-allowed" href="#" @endif
                                        class="register-btn"><span><svg fill="#000000" height="24px" width="24px"
                                                ...
                                                <g id="SVGRepo_iconCarrier">
                                                    <g>
                                                        <path
                                                            d="M148.5,0C66.485,0,0,66.485,0,148.5S66.485,297,148.5,297S297,230.515,297,148.5S230.515,0,148.5,0z M159.083,231.5H90.75 l74.25-84l-74.25-81h68.333l71.917,81L159.083,231.5z">
                                                        </path>
                                                    </g>
                                                </g>
                                ...
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed  dark:text-white">
                                    <span style="color: #C3A37D;">ROUND 1:</span> ONLINE AUDITION SUBMISSION IS FREE OF
                                    COST
                                </p>
                            </div>
                        </div>
            ...
            <div class="text-center">
                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed  dark:text-white">
                    <a href="https://www.battleofthebeats.in/privacy-policy">PRIVACY POLICY</a> - <a
                        href="https://www.battleofthebeats.in/refundandcancellation">REFUND & CANCELLATION</a> - <a
                        href="https://www.battleofthebeats.in/termsandconditions">TERMS & CONDITIONS</a> - <a
                        href="https://www.battleofthebeats.in/faq">FAQ'S</a>
                </p>
                <h2 class="text-xl text-white font-bold mx-4">Organized by:</h2>
