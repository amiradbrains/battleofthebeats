         ...
         <div class="max-w-7xl mx-auto p-6 lg:p-8  z-10">
            <div class="flex justify-center mt-6">
                <!-- <img src="{{ asset('images/logo-or.png') }}" width="150px"
                    ...
                    <iframe width="300" height="160" src="https://www.youtube-nocookie.com/embed/K4TOrB7at0Y?si=BEN9rIb_30_0AWWt&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed  dark:text-white">
                               PRIVACY POLICY - REFUND & CANCELLATION - TERMS & CONDITIONS - FAQ'S
                            </p>
